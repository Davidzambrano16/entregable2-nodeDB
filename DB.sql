...
('David', 'david@gmail.com', '12345', 23),
('Alejandro', 'alejandro@gmail.com', '6789', 55);

select * from "user" u ;

insert into author (firstname, lastname, "user") values
('Oscar', 'Rojas', 'OscarRojas'),
('Nico','Zambrano','NicoZambrano');
...
'Hallan por primera vez fosiles en Venezuela'),
